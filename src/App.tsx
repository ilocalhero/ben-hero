...
import { HomePage, TemasPage, PerfilPage, NotFoundPage, TemaPage, LessonPage, ActivityPage, DailyMissionPage, LoginPage, OnboardingPage, AwardsPage, SeasonPage } from './pages'
